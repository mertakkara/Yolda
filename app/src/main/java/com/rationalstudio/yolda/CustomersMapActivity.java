...
public class CustomersMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logout = (Button) findViewById(R.id.customer_logout_btn);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if(dataSnapshot.exists()  &&  requestType)
                        {
                            ...
                            DriverMarker = mMap.addMarker(new MarkerOptions().position(CustomerPickUpLocation).title("Your driver is here").icon(BitmapDescriptorFactory.fromResource(R.drawable.car)));
